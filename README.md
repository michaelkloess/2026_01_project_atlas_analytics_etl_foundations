# 📕 Project_Atlas_Analytics_ETL_Foundations
...
- [01_raw/](./02_data/01_raw/) → Just Raw Datasets without any modification
- [02_interim/](./02_data/02_interim/) → Intermediate cleaned or transformed datasets 
- [03_processed/](./02_data/03_processed/) → Final datasets ready to ship
...
- [01_eda_answers.md](./04_outputs/day1_eda_answers.md) → Google Sheet Analysis Insights Documentation
- [02_sat_modeling_summary](./04_outputs/day4_sat_modeling_summary.md) → ETL workflow cleaning logic and challenges 
